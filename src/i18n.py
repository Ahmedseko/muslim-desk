...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "alarm_active":   {"id": "🔔 Alarm Aktif  ·  Klik untuk Matikan",  "en": "🔔 Alarm On  ·  Click to Disable"},
    "alarm_inactive": {"id": "🔕 Alarm Mati  ·  Klik untuk Aktifkan", "en": "🔕 Alarm Off  ·  Click to Enable"},
    ...
    "quran_cached":     {"id": "📱 Cache lokal",          "en": "📱 Local cache"},
    ...
    "quran_last_read":  {"id": "Terakhir dibaca",         "en": "Last read"},
    "quran_continue":   {"id": "Lanjutkan",               "en": "Continue"},
    "quran_bookmarks":  {"id": "Bookmark",                "en": "Bookmarks"},
    "quran_no_bm":      {"id": "Belum ada bookmark.\nTandai ayat dengan 🔖.", "en": "No bookmarks yet.\nTap 🔖 on a verse."},
